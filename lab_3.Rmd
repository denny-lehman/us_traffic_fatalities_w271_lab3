...
data_clean <- data_clean %>% mutate(log_total_fatalities_rate=log(total_fatalities_rate))
```
...
```{r}
preliminary_model  <- plm(log_total_fatalities_rate ~ year-1, data = data_clean,
