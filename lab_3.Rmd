...
We need to evaluate the error here. Choose the right standard error and then do the reporting. End with a stargazer report

```{r}
fixed_effect_model
summary(fixed_effect_model)$coe # normal se
## heteroscedasticity-robust SE
summary(fixed_effect_model, vcov=vcovHC(fixed_effect_model, method="white1", type="HC1"))$coe
