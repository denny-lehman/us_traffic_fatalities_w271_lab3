...
mod <- lm(total_fatalities_rate ~ d80 + d81 + d82 + d83 + d84 + d85 +d86 + d87 + 
            ...
            d99 + d00 + d01 +d02 + d03, data = data_clean)
summary(mod)
# make sure year is a factor, not int
```

```{r}
# alternative model recommended by scott  because it's easier
# mod2 <- lm(totfatrte ~ factor(year), data=data)
# summary(mod2)
```
...
data_clean %>% 
  mutate(
    bac08_in_effect = round(bac08),
    bac10_in_effect = round(bac10)
  ) %>%
  dplyr::select(-c(bac08, bac10)) -> data_clean_1

mod2 <- lm(total_fatalities_rate ~ d80 + d81 + d82 + d83 + d84 + d85 +d86 + d87 + 
            d88 + d89 + d90 + d91 + d92 + d93 + d94 +d95 + d96 + d97 + d98 +
            d99 + d00 + d01 +d02 + d03 + 
             bac08_in_effect + bac10_in_effect, data = data_clean_1)
summary(mod2)

mod3 <- lm(total_fatalities_rate ~ bac08_in_effect + bac10_in_effect, data = data_clean_1)
summary(mod3)
