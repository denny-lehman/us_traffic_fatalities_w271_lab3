...
data_clean <- data %>% mutate(
  ...
  # blood_alcohol_limit = factor(
  #   if_else(round(bac10) == 1, 'bac10', 
  #           if_else(round(bac08) ==1, 'bac08', 'none')),
  #   labels = c('none', 'bac08', 'bac10')), 
...
$$log(total .fatality.rate_{1980}) = \beta_0 $$
$$log(tot.fat.rate_{i}) = \beta_{1980} + \Sigma_{i=1981}^{2004}\beta_i*I(year_i)$$
...
```{r convert bac08 and bac10}
expanded_model <- lm(log_total_fatalities_rate ~ blood_alcohol_limit + 
                       per_se_law  +
                       seat_belt +
                       speed_limit_70plus +
                       graduated_drivers_license_law
