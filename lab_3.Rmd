...
data %>% mutate(log_total_fatalities_rate = log(totfatrte),
                total_fatalities_rate = totfatrte) %>%
ggplot(aes(x=total_fatalities_rate)) + geom_histogram(aes(y=..density..), alpha=0.7) + geom_density(alpha=0.3, fill="red") +geom_vline(aes(xintercept=mean(total_fatalities_rate)), color="black", linetype="dashed", size=1) +
...
# test log transform
data_clean %>%
  ggplot(aes(x=log_total_fatalities_rate)) + geom_histogram(aes(y=..density..), alpha=0.7) + geom_density(alpha=0.3, fill="red") +geom_vline(aes(xintercept=mean(log_total_fatalities_rate)), color="black", linetype="dashed", size=1) +
